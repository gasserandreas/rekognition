...
const PrivacyView = () => (
  <StyledView>
    <Heading margin={{ top: 'small', bottom: 'none' }}>
      Privacy Policy
    </Heading>
    ...
    <p>
      ...
      {' '}
      www.rekognition.gasserandreas.com website and the Rekognition
    ...
    <p>
      ...
      used to contact or identify you (&quot;Personal Data&quot;). Personally identifiable information
      {' '}
...
We use Security Cookies for security purposes.
    ...
    <p>Rekognition uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>
      If you are located outside Switzerland and choose to provide information to us, please note that we transfer the
      data, including Personal Data, to Switzerland and process it there.
    </p>
    <p>
    ...
    <p>
      Rekognition will take all steps reasonably necessary to ensure that your data is treated securely and in
    ...
    <p>Rekognition may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>To protect and defend the rights or property of Rekognition</li>
    ...
    <p>
      ...
      {' '}
      Service (&quot;Service Providers&quot;), to provide
    ...
    <ul>
      <li>By visiting this page on our website: www.andreasgasser.com</li>
    </ul>

    <p>
      Navigate back to
      <Link to={Paths.HOME}>start view</Link>
    </p>
  </StyledView>
);
