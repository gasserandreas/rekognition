...
const sharedKnobs = {
  getAppearance: () => select('appearance', {
...
storiesOf('Message', module)
  .add('default', () => (
    <Message
      appearance={sharedKnobs.getAppearance()}
      border={sharedKnobs.getBorder()}
      rounded={sharedKnobs.getRounded()}
    >Hello world. There could be your styled message</Message>
    ));
