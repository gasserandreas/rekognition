...
describe('Message info styles test suite', () => {
  ...
  it('Message should render without border', () => {
    const wrapper = shallow(<Message appearance={MESSAGE_TYPES.INFO} border={false}><p>Hello</p></Message>);
    expect(toJson(wrapper.dive())).toMatchSnapshot();
  });
...
describe('Message warning styles test suite', () => {
  ...
  it('Message should render without border', () => {
    const wrapper = shallow(<Message appearance={MESSAGE_TYPES.WARNING} border={false}><p>Hello</p></Message>);
    expect(toJson(wrapper.dive())).toMatchSnapshot();
  });
...
describe('Message error styles test suite', () => {
  ...
  it('Message should render without border', () => {
    const wrapper = shallow(<Message appearance={MESSAGE_TYPES.ERROR} border={false}><p>Hello</p></Message>);
    expect(toJson(wrapper.dive())).toMatchSnapshot();
  });
